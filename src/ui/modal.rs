use crate::app::{
    ...
    ModalState, ProjectModal, ProjectModalField, SearchProjectModal,
};
use crate::model::{Project, QueryHistory};
use ratatui::{
...
pub fn draw_modal(frame: &mut Frame, modal_state: &ModalState, projects: &[Project], history: &QueryHistory) {
    match modal_state {
        ModalState::None => {}
